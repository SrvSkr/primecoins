...
<div class="container hero-image"><!-- Main image banner -->
    ...
    <div class="row jumbo fullwidth" id="<?php echo $page;?>">c
...
<div class="container-fluid page-header fullwidth">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <img class="tenant-image" src="images/people/female_2.jpg">
                </div>
               <div class="col-sm-7 property_header">
                   <h2 class="page-header">Aoife Flanagan</h2>
                   <span>Fuel Injection Engineer, 33</span>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="left-column pb15 col-sm-5">
               <ul>
                ...
                <li><img src="images/icon_money.png"><h6>Proof of Funding Downloads</h6></a><a href="content/test.pdf"><span>Bank Statement</span></a></li>
                   <li><img src="images/icon_3ppl.png"><h6>Aoife is searching with 1 friend</h6><a href="content/test.pdf"><span>John Smith</span></a></li>
                   <li><br></li>
        ...
        <div class="col-sm-7">
            ...
            <a href="#"data-toggle="modal" data-target="#contact-modal"> <button class="pb15 tenbut amber">Contact Aoife</button></a>
        </div>
    </div>
</div>
