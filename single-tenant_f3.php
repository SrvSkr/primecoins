...
<div class="container-fluid page-header fullwidth">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <img class="tenant-image" src="images/people/group_3.jpg">
                </div>
               <div class="col-sm-7 property_header">
                   <h2 class="page-header">Éilis Ní Faoiláin</h2>
                   <span>Architect, 30</span>
                </div>
            </div>
        </div>
...
<div class="container tenant-content">
    <div class="row">
        ...
        <div class="col-sm-7">
            ...
            <a href="#"data-toggle="modal" data-target="#contact-modal"> <button class="amber tenbut pb15">Contact Éilis</button></a>
        </div>
    </div>
</div>
