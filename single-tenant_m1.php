...
<div class="container-fluid page-header fullwidth">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <img class="tenant-image" src="images/people/male_1.jpg">
                </div>
               <div class="col-sm-7 property_header">
                   <h2 class="page-header">Patrick Murphy</h2>
                   <span>Store Cashier, 29</span>
                </div>
            </div>
        </div>
...
<div class="container tenant-content">
    <div class="row">
        <div class="left-column col-sm-5 pb15">
               <ul>
                ...
                <li><img src="images/icon_money.png"><h6>Proof of Funding Downloads</h6><a href="content/test.pdf"><span>Bank Statement</span></a></li>
                   <li><img src="images/icon_3ppl.png"><h6>Pádraig is searching with 1 friend</h6><a href="content/test.pdf"><span>John Smith</span></a></li>
                   <li><br></li>
        ...
        <div class="col-sm-7">
            ...
            <h4>Reviews</h4>
            <blockquote class="pb15">Patrick was a fantastic tenant for the last three years. He has always paid rent on time and left the place in perfect condition when it was time to move out, highly recommended!<footer>Senan Cronin - 2018</footer></blockquote>
            ...
            <a href="#"data-toggle="modal" data-target="#contact-modal"><button class="amber tenbut pb15">Contact Patrick</button></a>
        </div>
    </div>
</div>
