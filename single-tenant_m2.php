...
<div class="container-fluid page-header fullwidth">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <img class="tenant-image" src="images/people/group_1.jpg">
                </div>
               <div class="col-sm-7 property_header">
                   <h2 class="page-header">John Smith</h2>
                   <span>Unemployed, 22</span>
                </div>
            </div>
        </div>
...
<div class="container tenant-content">
    <div class="row">
        <div class="left-column col-sm-5 pb15">
               <ul>
                ...
                <li><img src="images/icon_money.png"><h6>Proof of Funding Downloads</h6><a href="content/test.pdf"><span>Bank Statement</span></a></li>
                   <li><img src="images/icon_3ppl.png"><h6>John is searching with 1 friend</h6><a href="content/test.pdf"><span>John Smith</span></a></li>
        ...
        <div class="col-sm-7">
            ...
            <h4>Reviews</h4>
            <blockquote class="pb15">Great tenant.<footer>Senan Cronin - 2018</footer></blockquote>
            ...
            <a href="#"data-toggle="modal" data-target="#contact-modal"><button class="amber tenbut pb15">Contact John</button></a>
        </div>
    </div>
</div>
