...
<section class="dropdown-search container-fluid">
    <h4 class="adv_searching text-center">What are you searching for?</h5>
        <div class="dropdown-search_inner container">
            <div class="row flexer" style="background-color:#fafafa">
            ...
            <div class="row dropdown-search-options <?php echo $viz; echo " ";echo $tenInviz;?>" id="prop-search-2">
                <div class="col-sm-4">
                    <fieldset>
                        <label>I am looking for...</label>
                        <select id="type" class="housetype">
                            <option value="">Room / House Share</option>
            ...
            <div class="row dropdown-search-options <?php echo $Lviz;?>" id="tenant-search-2">
                <div class="col-sm-4">
                    <fieldset>
                        <label>Seeking</label>
                ...
                <div class="col-sm-4">
                    ...
                    <fieldset>
                        ...
                        <select>
                            ...
                            <option value="student">Gaeilge</option>
            ...
            <div class="row dropdown-search-options <?php echo $Sviz;?>" id="swap-search-2">
                <div class="col-sm-4">
                    <fieldset>
