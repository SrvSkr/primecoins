...
<div class="container-fluid page-header fullwidth">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <img class="tenant-image" src="images/people/male_2.jpg">
                </div>
               <div class="col-sm-7 property_header">
                   <h2 class="page-header">Pádraig de Paor</h2>
                   <span>Web Developer, 29</span>
                </div>
            </div>
        </div>
...
<div class="container tenant-content">
    <div class="row">
        <div class="left-column col-sm-5 pb15">
               <ul>
                ...
                <li><img src="images/icon_money.png"><h6>Proof of Funding Downloads</h6><a href="content/test.pdf"><span>Bank Statement</span></a></li>
                   <li><img src="images/icon_3ppl.png"><h6>Pádraig is searching with 1 friend</h6><a href="single-tenant_m2.php"><span>John Smith</span></a></li>
                   <li><br></li>
        ...
        <div class="col-sm-7">
            ...
            <h4>Reviews</h4>
            <blockquote class="pb15">Great tenant, easy to deal with...<footer>Senan Cronin - 2018</footer></blockquote>
            ...
            <button class="amber tenbut pb15">Contact Pádraig</button></a>
        </div>
    </div>
</div>
